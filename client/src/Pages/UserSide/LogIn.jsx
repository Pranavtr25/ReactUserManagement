...
const LogIn = () => {
  ...
  return (
    <>
      <div className="flex justify-center items-center h-screen bg-[#c3dfe6]">
        <div className="h-auto w-[85%] md:w-[60%] lg:w-[40%] bg-[#05393c] justify-center flex rounded-lg shadow-2xl">
          <ToastContainer/>
